...
- ../spec-nova3D/SPEC.md
sources:
- ../../planning-artifacts/story-inputs/story-7-7.json
---
...
An Account owner needs to receive useful phone alerts. They can return to completed work without losing in-app history.

## Capabilities

- **CAP-1**
  - **intent:** An Account owner can receive useful phone alerts.
  - **success:** Payloads contain opaque references and generic category text, not private names, images or source excerpts.
...
Payloads contain opaque references and generic category text, not private names, images or source excerpts. The exact criteria demonstrate the complete story outcome and its failure boundaries; any gate-status change requires actual qualification evidence.
