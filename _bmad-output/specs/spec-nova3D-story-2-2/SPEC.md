...
- ../spec-nova3D/SPEC.md
sources:
- ../../planning-artifacts/story-inputs/story-2-2.json
---
...
An Account owner needs to choose images or take photos of one subject. The request preserves all useful views.

## Capabilities

- **CAP-1**
  - **intent:** An Account owner can choose images or take photos of one subject.
  - **success:** Permission is requested then; denial leaves existing-file intake usable.
...
Permission is requested then; denial leaves existing-file intake usable. The exact criteria demonstrate the complete story outcome and its failure boundaries; any gate-status change requires actual qualification evidence.
