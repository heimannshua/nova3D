...
- ../spec-nova3D/SPEC.md
sources:
- ../../planning-artifacts/story-inputs/story-6-5.json
---
...
An Account owner needs to recover once after local repair fails. Automatic recovery has a firm limit.
