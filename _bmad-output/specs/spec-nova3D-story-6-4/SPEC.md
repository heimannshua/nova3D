...
- ../spec-nova3D/SPEC.md
sources:
- ../../planning-artifacts/story-inputs/story-6-4.json
---
...
An Account owner needs to repair fixable defects automatically. Small repairs preserve approved shape and larger changes return for review.

## Capabilities

- **CAP-1**
  - **intent:** An Account owner can repair fixable defects automatically.
  - **success:** The repaired artifact is recorded and may retain Model Version only when certified canonical-to-repaired equivalence proves no consequential change.
...
The repaired artifact is recorded and may retain Model Version only when certified canonical-to-repaired equivalence proves no consequential change. The exact criteria demonstrate the complete story outcome and its failure boundaries; any gate-status change requires actual qualification evidence.
