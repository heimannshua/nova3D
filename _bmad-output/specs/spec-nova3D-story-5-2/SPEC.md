...
- ../spec-nova3D/SPEC.md
sources:
- ../../planning-artifacts/story-inputs/story-5-2.json
---
...
An Account owner needs to apply an approved correction. Unrelated geometry stays within the agreed tolerance.

## Capabilities

- **CAP-1**
  - **intent:** An Account owner can apply an approved correction.
  - **success:** Every dependent feature is rebuilt and records the new activity, recipe and evidence bindings.
...
Every dependent feature is rebuilt and records the new activity, recipe and evidence bindings. The exact criteria demonstrate the complete story outcome and its failure boundaries; any gate-status change requires actual qualification evidence.
