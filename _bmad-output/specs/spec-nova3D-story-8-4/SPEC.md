...
- ../spec-nova3D/SPEC.md
sources:
- ../../planning-artifacts/story-inputs/story-8-4.json
---
...
An Account owner needs to recover surviving work after a failure. Backups restore geometry and enforce every intervening deletion.

## Capabilities

- **CAP-1**
  - **intent:** An Account owner can recover surviving work after a failure.
  - **success:** The external deletion ledger replays before access opens and every surviving manifest/artifact is verified.
...
The external deletion ledger replays before access opens and every surviving manifest/artifact is verified. The exact criteria demonstrate the complete story outcome and its failure boundaries; any gate-status change requires actual qualification evidence.
