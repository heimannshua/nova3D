...
- ../spec-nova3D/SPEC.md
sources:
- ../../planning-artifacts/story-inputs/story-1-7.json
---
...
An Account owner needs to find and reopen their Projects. They can resume the next required action.

## Capabilities

- **CAP-1**
  - **intent:** An Account owner can find and reopen their Projects.
  - **success:** The three primary actions and useful empty states are visible on phone and desktop.
...
The three primary actions and useful empty states are visible on phone and desktop. The exact criteria demonstrate the complete story outcome and its failure boundaries; any gate-status change requires actual qualification evidence.
