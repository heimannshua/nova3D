...
- ../spec-nova3D/SPEC.md
sources:
- ../../planning-artifacts/story-inputs/story-4-5.json
---
...
An Account owner needs to move between a feature and its evidence. They can inspect what justifies each consequential shape.
