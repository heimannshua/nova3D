...
- ../spec-nova3D/SPEC.md
sources:
- ../../planning-artifacts/story-inputs/story-1-4.json
---
...
An Account owner needs to access only their workspace. Their projects and files stay private.

## Capabilities

- **CAP-1**
  - **intent:** An Account owner can access only their workspace.
  - **success:** Reads and writes disclose no private content and cannot create cross-Workspace references.
...
Reads and writes disclose no private content and cannot create cross-Workspace references. The exact criteria demonstrate the complete story outcome and its failure boundaries; any gate-status change requires actual qualification evidence.
