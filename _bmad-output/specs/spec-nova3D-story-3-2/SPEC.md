...
- ../spec-nova3D/SPEC.md
sources:
- ../../planning-artifacts/story-inputs/story-3-2.json
---
...
An Account owner needs to exclude a source locally or across their Projects. Research follows their source choices without rewriting history.
