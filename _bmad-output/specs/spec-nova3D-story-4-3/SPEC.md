...
- ../spec-nova3D/SPEC.md
sources:
- ../../planning-artifacts/story-inputs/story-4-3.json
---
...
An Account owner needs to verify that unchanged geometry stayed unchanged. Regeneration and minor repair cannot silently alter the model.

## Capabilities

- **CAP-1**
  - **intent:** An Account owner can verify that unchanged geometry stayed unchanged.
  - **success:** Feature identity, component count and closed-solid topology match; no best-fit or independent rescaling is used.
...
Feature identity, component count and closed-solid topology match; no best-fit or independent rescaling is used. The exact criteria demonstrate the complete story outcome and its failure boundaries; any gate-status change requires actual qualification evidence.
