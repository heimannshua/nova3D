...
- ../spec-nova3D/SPEC.md
sources:
- ../../planning-artifacts/story-inputs/story-5-5.json
---
...
An Account owner needs to approve or reject the model they inspected. Export cannot use a different candidate.

## Capabilities

- **CAP-1**
  - **intent:** An Account owner can approve or reject the model they inspected.
  - **success:** Approval is blocked and the exact required inspection is identified.
...
Approval is blocked and the exact required inspection is identified. The exact criteria demonstrate the complete story outcome and its failure boundaries; any gate-status change requires actual qualification evidence.
