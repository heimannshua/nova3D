...
- ../spec-nova3D/SPEC.md
sources:
- ../../planning-artifacts/story-inputs/story-2-10.json
---
...
An Account owner needs to open the exact item needing attention. Background progress remains usable across sessions.
