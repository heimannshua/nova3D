...
- ../spec-nova3D/SPEC.md
sources:
- ../../planning-artifacts/story-inputs/story-2-1.json
---
...
An Account owner needs to describe the desired model and personal additions. Work starts from their confirmed intent.
